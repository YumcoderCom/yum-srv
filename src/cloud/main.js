...
export default () => {
  ...
  /*cloud(path.resolve(__dirname + "/functions/"), (functionName, handler) => {
    Parse.Cloud.define(functionName, handler);
  });*/

  cloud(path.resolve(__dirname + "/jobs/"), (functionName, handler) => {
    Parse.Cloud.job(functionName, handler);
  });
